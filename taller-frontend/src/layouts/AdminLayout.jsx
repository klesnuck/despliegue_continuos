...
export default function AdminLayout({ children, activeTab, onTabClick }) {
  ...
  const menu = [
    { label: 'Dashboard', id: 'dashboard', icon: 'M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z' },
  ...
  return (
    <div className="flex h-screen bg-gray-50 text-left overflow-hidden">
        ...
        <aside className="w-64 bg-blue-950 text-white flex flex-col h-full shrink-0">
          <div className="p-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-blue-200 uppercase tracking-widest">Admin</p>
            </div>
          </div>
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden bg-gray-50/50">
        ...
        <header className="h-14 bg-red-900 border-b border-gray-200 flex items-center justify-between px-6 shrink-0 shadow-sm">
          <button onClick={toggleSidebar} className="text-white hover:bg-gray-100 p-2 rounded-lg transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
